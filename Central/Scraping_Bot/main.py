...
## Tag needed to be added to the code <div class="country-info">
...
class ScraperBot:
    ...
    def process_data(self, soup, page_url):
        with open(self.output_file, 'a') as f:  # 'a' mode appends to the file
...
if __name__ == "__main__":
    ...
    # Optionally provide a list of endpoints, or leave empty to scrape just the base URL
    endpoints = [
        # "page1",
        # "page2",
        # "page3"
